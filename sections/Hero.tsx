          ...
          <div className="relative group w-full">
            ...
            <div className="overflow-hidden mb-8 md:mb-12">
              <motion.h1
                ...
                className="text-[17vw] md:text-[11rem] font-extrabold tracking-tighter leading-[0.85] md:leading-[0.8] uppercase text-transparent bg-clip-text bg-gradient-to-r from-[#00f2ff] via-[#ffcc00] to-[#ffcc00] select-none"
              >
                PAGES.
              </motion.h1>
            </div>
